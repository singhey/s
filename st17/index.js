...
function download() {
  //e.preventDefault();
  document.getElementById("downloader").download = Date.now()+"_ST17.jpeg";
  console.log("hello")
  document.getElementById("downloader").href = document.querySelector("canvas").toDataURL("image/jpeg");
}