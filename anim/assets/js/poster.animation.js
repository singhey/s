$(function(){
	...
	menuAnimation
		...
		.fromTo(mobileHeader, 1,{backgroundColor:"transaparent"}, {boxShadow: "0px 4px 16px #999", backgroundColor: "#fff"})
		.staggerFromTo(cards, 1, {backgroundColor: "transaparent", width: 2}, {backgroundColor: "#fff", width: 2})
